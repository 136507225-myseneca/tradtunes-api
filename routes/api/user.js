...
// @access  Public
router.post('/playlist/create', passport.authenticate('user', {
    session: false
...
// @access  Public
router.delete('/playlist/delete/:id', passport.authenticate('user', {
    session: false
...
// @access  Public
router.put('/playlist/update', passport.authenticate('user', {
    session: false
